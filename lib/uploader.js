...
let response = await fetch("https://widipe.com/api/upload.php", {
method: "post",
body: bodyForm,
});
let data = await response.json()
resolve(data.result.url.toString())
		} catch (e) {
			reject(e)
		}
	})
...
async function uploaderV2 (buffer) {
...
module.exports = { TelegraPh, uploaderV2, webp2mp4File }
